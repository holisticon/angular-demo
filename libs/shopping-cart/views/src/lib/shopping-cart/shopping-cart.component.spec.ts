...
import { newOrder } from '@ngxp/orders/domain/test';
import { OrdersStore } from '@ngxp/orders/state';
import { ResourceWith } from '@ngxp/resource';
import { QuantityUpdate, ShoppingCartItem } from '@ngxp/shopping-cart/domain';
import { emptyShoppingCart, shoppingCart, shoppingCartItem } from '@ngxp/shopping-cart/domain/test';
import { ShoppingCartStore } from '@ngxp/shopping-cart/state';
import { ShoppingCartItemListComponent } from '@ngxp/shopping-cart/ui';
import { provideStoreServiceMock, StoreServiceMock } from '@ngxp/store-service/testing';
import { userProfile } from '@ngxp/user-profile/domain/test';
