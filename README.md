...
The `shopping-cart-common` lib exports its `addToShoppingCartAction` and `itemAddedToShoppingCartAction` through the `index.ts`, making it possible to dispatch these actions in other modules.
